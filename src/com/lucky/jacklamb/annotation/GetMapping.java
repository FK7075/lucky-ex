 ...
 * 		     标注在方法上定义一个响应方法，类上的value与方法上的value唯一标识一个响应方法
 * 		  eg:
 * 		  Rest风格的URL:http://127.0.0.1:8080/lucky/server/query/fk/12
 *        +@Controller
 ...
 *        
 *        } 
 * 		  Lucky根据请求的url唯一定位到一个Controller方法
 * 	method[]：对请求的类型进行限制，默认接受GET POST PUT DELETE 四组请求
 * @author fk-7075
 *
 */
