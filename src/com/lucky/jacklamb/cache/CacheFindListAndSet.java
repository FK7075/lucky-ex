...
public final class CacheFindListAndSet extends StartCache {
	...
	public <T> List<?> getPagList(T t, int index, int size) {
		// TODO Auto-generated method stub
		return super.getPagList(t, index, size);
	}

	public <T> List<?> getSortList(T t, String property, int r) {
		// TODO Auto-generated method stub
		return super.getSortList(t, property, r);
	}

	public <T> List<?> getFuzzyList(Class<?> c, String property, String info) {
		// TODO Auto-generated method stub
		return super.getFuzzyList(c, property, info);
	}
